...
//             <CardTitle className="text-3xl text-gray-900">Portfolio Growth Overview</CardTitle>
//           </CardHeader>
...
//       <div className="px-8 pt-12 pb-60">
//         <Card className="border-orange-500 border-t-8">
//           <CardHeader className="bg-gray-50">
//             <CardTitle className="text-3xl text-gray-900">Growth Phase Analysis</CardTitle>
//           </CardHeader>
...
//         <Card className="border-orange-500 border-t-8">
//           <CardHeader className="bg-gray-50">
//             <CardTitle className="text-3xl text-gray-900">Property Acquisition Timeline</CardTitle>
//           </CardHeader>
//           <CardContent className="p-6">
//             <div className="h-[250px]">
...
//       <div className="px-8 pt-16 pb-48">
//         <Card className="border-orange-500 border-t-8">
//           <CardHeader className="bg-gray-50">
//             <CardTitle className="text-3xl text-gray-900">Retirement Monthly Income Projection</CardTitle>
//           </CardHeader>
//           <CardContent className="p-6">
//             <div className="h-[250px]">
...
//         <Card className="border-orange-500 border-t-8">
//           <CardHeader className="bg-gray-50">
//             <CardTitle className="text-3xl text-gray-900">Investment Comparison</CardTitle>
//           </CardHeader>
//           <CardContent className="p-6">
...
//         {/* Footer */}
//         <div className="mt-12 pt-6 border-t text-center text-gray-100 text-lg">
